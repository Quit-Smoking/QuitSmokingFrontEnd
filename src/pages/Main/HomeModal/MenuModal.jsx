...
const MenuModal = ({ nickname, email, determine, navigate, onClose, resolution, differenceInDays, differenceInHours, differenceInMinutes, differenceInSeconds, savedMoneyExact, disableClock ,extendedLifeDays}) => {
    ...
    const handleStopSmoking = () => {
        if (!disableClock) {
            navigate("/stopsmoking", { state: { resolution, differenceInDays, differenceInHours, differenceInMinutes, differenceInSeconds, savedMoneyExact ,extendedLifeDays} });
        }
    };
